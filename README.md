...
- `pages/boardspace_atlas/` hosts BoardSpace Atlas with an in-browser synthetic archive plus an optional live-play client that can connect to a user-supplied AlphaZero-style backend.
