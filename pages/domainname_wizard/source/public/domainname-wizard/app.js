(function () {
  ...
  const BACKEND_URL = (function () {
    var origin = 'https://order-skew-p3cuhj7l0-yanniedogs-projects.vercel.app';
    if (typeof window !== 'undefined' && window.location && window.location.protocol === 'https:' && window.location.origin && /vercel\.app$/i.test(window.location.hostname || '')) {
